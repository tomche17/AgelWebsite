...
<title>Votre commande N°{{$commande->id}} a été enregistrée !</title>
...
<table width="640" border="0" align="center" cellpadding="0" cellspacing="0">
 ...
 <tr>
    <td width="20" valign="top">&nbsp;</td>
    <td width="600" valign="top"><p style="margin:0px; padding:0px; font-size:14px;"><font face="Tahoma, Verdana, Segoe, sans-serif">{{$commande->event->nom}} - {{$commande->event->date}}</font></p></td>
    <td width="20" valign="top">&nbsp;</td>
 </tr>
...
@foreach($commande->materiels as $materiel)
  @if($materiel->pivot->nombre > 0)
    <tr>
       <td width="20" valign="top">&nbsp;</td>
       <td width="600" valign="top"><p style="margin:0px; padding:0px; font-size:14px;"><font face="Tahoma, Verdana, Segoe, sans-serif">{{$materiel->nom}} x {{$materiel->pivot->nombre}}</font></p></td>
       <td width="20" valign="top">&nbsp;</td>
    </tr>
  @endif
@endforeach
