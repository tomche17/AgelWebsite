            ...
            <div class="hero-inner">
                <div class="content content-full text-center">
                    <div class="pt-100 pb-150">
                        <img src="{{ asset('media/logos/agel.png') }}" class="centered img-fluid" style="max-width:50">
                        <h1 class="font-w700 display-4 mt-20 invisible" data-toggle="appear" data-timeout="50">
                            <span class="font-w300">Plateforme</span>
                            Événements
                        </h1>
                        <h2 class="h3 font-w400 text-muted mb-50 invisible" data-toggle="appear" data-class="animated fadeInDown" data-timeout="300">
                            Vous êtes membre d'un comité ? Connectez-vous !
                        </h2>
                        <div class="invisible" data-toggle="appear" data-class="animated fadeInUp" data-timeout="300">
                            <a class="btn btn-hero btn-alt-primary min-width-175 mb-10 mx-5" href="/login">
                                <i class="fa fa-fw fa-arrow-right mr-1"></i> Se connecter
                            </a>
                        </div>
                    </div>
                </div>
